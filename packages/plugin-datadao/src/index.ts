...
import { messageHandlerTemplate } from './utils/index.ts';
...
export const datadaoPlugin: Plugin = {
  name: 'datadao',
  description: 'DataDAO plugin with essential actions and evaluators',
  actions: [actions.ignoreAction, actions.noneAction, actions.replyAction],
